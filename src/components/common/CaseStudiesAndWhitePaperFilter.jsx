  ...
  return (
    <div className='h-[80px] w-full fsTwo flex  justify-between border-b border-[#E8E8E8]'>
      ...
      <div className='h-full flex items-center gap-3'>
         <div className={`z-10 h-[45px] cursor-pointer border-1  min-w-[190px] hover:bg-[#e8e8e85e] flex justify-center items-center gap-2 border-[#E8E8E8] font-medium transition-all rounded-full`}>
          <img className='h-[15px]' src='./icons/plus.png'/> New Case Study</div>
