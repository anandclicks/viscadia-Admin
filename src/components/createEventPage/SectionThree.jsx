          ...
          <div>
            <div className="flex items-center my-2">
              {createEventFormData?.speaker.map((el,index)=>(
               ...
               <input type="text" onInput={(evt)=> handleSpeakersInputsChanges(evt,index)} value={el.fullName} name="fullName" placeholder="Speaker Name" className="generalCssForInputs w-[130px] text-[19px] text-[#BD2F2C] placeholder:text-[#BD2F2C]" />
