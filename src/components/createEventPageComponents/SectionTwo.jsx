        ...
        <div className="w-[100%] relative z-10 flex justify-end">
          <div className="w-[90%]">
            <div className="h-[60px] ">
              <input
                placeholder="HEADING"
                className="w-full h-full outline-0 border-0  text-white placeholder:text-white  text-[31px] font-light"
                type="text"
                name=""
                id=""
              />
            ...
            <div className="h-[30px] ">
              <input
                ...
                className="w-full h-full outline-0 border-0  text-white placeholder:text-white  text-[25px] font-light"
                type="text"
                name=""
                id=""
              />
