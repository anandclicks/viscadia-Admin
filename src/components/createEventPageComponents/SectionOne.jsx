...
const SectionOne = () => {
  ...
  const { setCreateEventFormData, createEventFormData } = useContext(EventPageContext);
  ...
  return (
    <div className="h-[340px] w-full shadow relative flex">
        ...
        <div className="">
          <div className="h-[40px] w-full">
            <input
              ...
              className="w-full h-full outline-0 border-0 text-[#133D65] placeholder:text-[#133D65]  text-[21px]"
              type="text"
              name=""
              id=""
            />
          ...
          <div className="mt-5 mb-3 flex gap-10 ">
            <div className="flex gap-2 min-w-[100px]">
              ...
              <input
                type="text"
                className="generalCssForInputs h-[20px] text-[15px] placeholder:font-medium"
                placeholder="September 10-12-2025"
                name="date"
                id=""
              />
            </div>
            <div className="flex gap-2 min-w-[60%]">
              ...
              <input
                type="text"
                className="generalCssForInputs h-[20px] text-[15px] placeholder:font-medium w-full"
      ...
      <div className="w-[40%] border-dashed border-[#960000] border h-full rightSide  bg-amber-400 z-0 flex justify-end relative">
       ...
       <input
            ...
            type="file"
            className="opacity-0 h-full end-0 cursor-pointer absolute z-10 w-[40%]"
            accept="image/*"
            name=""
            id=""
          />
