    ...
    <div className="min-h-[300px] w-full shadow flex">
      <div className="h-[300px] p-5 w-[60%] flex flex-col justify-end">
        <div className="flex flex-col min-w-[200px]">
          ...
          <div className="h-[90px] w-[90px] mt-4 rounded-full border border-[#BD2F2C] border-dashed bg-[#FFF8F8] relative">
            <input type="file" className="h-full w-full absolute top-0 left-0 z-10 opacity-0 cursor-pointer rounded-full" name="" id="" />
            <div className="flex flex-col justify-center items-center h-full w-full">
              <img
                ...
                alt=""
              />
              <h3 className="text-[#BD2F2C] mt-2 text-[12px]">Upload Image</h3>
            </div>
          </div>
        </div>
      </div>
      <div className="max-h-[300px] h-[300px] w-[40%] relative border border-dashed border-[#BD2F2C] bg-[#FFF8F8]">
        <input type="file" className="h-full w-full absolute cursor-pointer z-10 opacity-0" name="" id="" />
