          ...
          <NavLink to={"/case-studies-and-white-papers"} className="flex items-center gap-3 px-2 py-2 text-[16px] cursor-pointer text-black rounded-lg duration-200 mt-2">
           ...
           <NavLink to={"/events-and-webinars"} className="flex items-center gap-3 px-2 py-2 text-[16px] cursor-pointer text-black rounded-lg duration-200 mt-2">
            {({ isActive }) => (
              ...
              <>
                <div className={`${isActive ? "activeTabs" : "bg-white"}  ${location.pathname == "/event/create" && "activeTabs" }  rounded-full h-[55px] w-[55px] flex justify-center items-center shadowcus1`}>
                  <img src={`${isActive || location.pathname === "/event/create" ? "../icons/eventWhite.png" : "../icons/event.png"}`} className="h-[30px] w-[30px]  text-black" alt="" />
                </div>
