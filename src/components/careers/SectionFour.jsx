      ...
      <div className='flex flex-col justify-center items-center w-full'>
        {createCareerData?.qualifications?.map((el, minIndex) => (
          <div key={minIndex} className='flex flex-col justify-center items-center w-full'>
            <textarea name="subHeading" value={el?.subHeading} onInput={(e) => handleObjInpusChanges(e, "qualifications", minIndex)} placeholder='Enter Sub Heading' className='placeholder:text-[21px] w-full text-start text-[21px] h-[40px] placeholder:text-black placeholder:text-start generalCssForInputs' />
