      ...
      <div className='flex flex-col justify-center items-center'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <div>
            ...
            <button type='button' className='bg-[#BD2F2C] text-[#fff] p-[4px] rounded-full font-medium px-4 mt-2 mb-10 text-[13px]'>Add More</button>
          </div>
        </div>
        <button className='bg-[#BD2F2C] flex items-center gap-2 text-[#fff] p-[6px] rounded-full font-medium px-6 text-[17px]'>
