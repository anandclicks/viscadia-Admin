...
import { commonGetApiCall, textareaAutoResize, toCamelCase, webinarPayload } from "../../utils/reuseableFunctions.js";
          ...
          <div className="h-[calc(100%-70px)] w-full shadow bg-white rounded-[30px] overflow-hidden">
            <div className="h-[70px] px-4 flex items-center justify-between">
              ...
              <div className="h-full flex items-center gap-5">
                <div className="relative">
                  ...
                  >
                    {webinarCreateData?.status === "live" ? "Publish" : webinarCreateData?.status}
            ...
            <div className="flex gap-2 h-[calc(100%-70px)] pb-2">
              <div className="w-[18%] h-full bg-white border-r border-stone-300">
                <ul>
                  <li onClick={() => handleScrolling(sectionOneRef)} className={`px-4 cursor-pointer flex items-center text-[18px] h-[45px] ${activeSection === "sectionOne" ? "font-bold activeEventPageSection text-black" : "text-stone-600"}`}>
                    <button>Banner</button>
                  </li>
                  <li onClick={() => handleScrolling(sectionTwoRef)} className={`px-4 cursor-pointer flex items-center text-[18px] h-[45px] ${activeSection === "sectionTwo" ? "font-bold activeEventPageSection text-black" : "text-stone-600"}`}>
                    <button>Key Points</button>
                  </li>
                  <li onClick={() => handleScrolling(sectionThreeRef)} className={`px-4 cursor-pointer flex items-center text-[18px] h-[45px] ${activeSection === "sectionThree" ? "font-bold activeEventPageSection text-black" : "text-stone-600"}`}>
                    <button>Webinar Video</button>
                  </li>
                  <li onClick={() => handleScrolling(sectionFourRef)} className={`px-4 cursor-pointer flex items-center text-[18px] h-[45px] ${activeSection === "sectionFour" ? "font-bold activeEventPageSection text-black" : "text-stone-600"}`}>
