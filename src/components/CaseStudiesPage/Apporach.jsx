  ...
  return (
    <div ref={ref} className="min-h-[500px] py-10 my-10 w-full shadow">
          ...
          <div key={mainIndex} className="h-full">
            ...
            <div className="mt-3">
              ...
              <div>
                ...
                <button onClick={() => addKeyPointsInArray("approach", mainIndex)} className="bg-[#BD2F2C] text-[#fff] p-[4px] rounded-full font-medium px-4 text-[13px]">
      ...
      <div className="flex justify-center w-full">
        <button onClick={() => addObjsInSections("approach")} className="bg-[#BD2F2C] text-[#fff] p-[6px] rounded-full font-medium px-4 text-[17px]">
          <i className="ri-add-line"></i> Add More
        </button>
      </div>
    </div>
