...
const Chellenges = () => {
  const { addObjsInSections, createCaseStudyData, handleObjInpusChanges,addKeyPointsInObjects } =
          ...
          <div key={mainIndex} className="h-full">
            <div className="h-[150px] w-[150px] rounded-full bg-[#FFF8F8] overflow-hidden border border-dashed border-[#BD2F2C]">
              <div className="flex h-full w-full relative flex-col items-center justify-center">
                <input
                  ...
                  name="img"
                  onChange={(evt) => {
                    handleObjInpusChanges(evt, "challenges", index);
                  }}
                  id=""
                />
            ...
            <div className="mt-3">
              ...
              <div>
                ...
                <button onClick={()=> addKeyPointsInObjects('challenges')} className="bg-[#BD2F2C] text-[#fff] p-[4px] rounded-full font-medium px-4 text-[13px] ">
