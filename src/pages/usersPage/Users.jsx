    ...
    <div>
      <div className="min-h-[40px] py-5 w-full fsTwo flex justify-between border-b border-b-stone-300">
        <h2 className="text-[22px] font-semibold">Users</h2>
         <Link to={'/add-user'} className={`z-10 cursor-pointer h-[45px] border-1  min-w-[170px] hover:bg-[#f3f3f3]  bg-white flex justify-center items-center gap-2 border-[#E8E8E8]  transition-all rounded-full`}>
          <img className='h-[15px]' src='./icons/plus.png'/> Add New User</Link>
      </div>
